...
import { renderWithProviders, setupDefaultMocks, cleanupMocks } from "../../../tests/testutils/test-setup";
...
describe("KopiaTable", () => {
  ...
  it("should render table with data", () => {
    renderWithProviders(<KopiaTable columns={columns} data={mockData} />);
  ...
  it("should render title and description when provided", () => {
    renderWithProviders(
      <KopiaTable columns={columns} data={mockData} title="Test Table" description="This is a test table" />,
    );
  ...
  it("should handle empty data", () => {
    renderWithProviders(<KopiaTable columns={columns} data={[]} />);

    expect(screen.getByText("No results.")).toBeInTheDocument();
  });

  it("should handle global filter when enabled", async () => {
    renderWithProviders(<KopiaTable columns={columns} data={mockData} enableGlobalFilter />);
  ...
  it("should handle row selection when enabled", () => {
    ...
    renderWithProviders(
      <KopiaTable columns={columns} data={mockData} enableRowSelection onSelectionChange={onSelectionChange} />,
    );
  ...
  it("should handle column visibility when enabled", () => {
    renderWithProviders(<KopiaTable columns={columns} data={mockData} enableColumnVisibility />);
  ...
  it("should handle sorting", () => {
    renderWithProviders(<KopiaTable columns={columns} data={mockData} />, { wrapper });
  ...
  it("should handle pagination", () => {
    ...
    renderWithProviders(<KopiaTable columns={columns} data={largeData} />, { wrapper });
  ...
  it("should apply custom className", () => {
    const { container } = renderWithProviders(
      <KopiaTable columns={columns} data={mockData} className="custom-class" />,
    );
  ...
  it("should select all rows on page", () => {
    renderWithProviders(<KopiaTable columns={columns} data={mockData} enableRowSelection />);
