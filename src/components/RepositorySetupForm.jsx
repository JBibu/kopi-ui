...
const FilesystemFields = ({ formState, onDirectorySelected }) => (
...
FilesystemFields.propTypes = {
  formState: PropTypes.object.isRequired,
  onDirectorySelected: PropTypes.func.isRequired,
};

export const RepositorySetupForm = forwardRef(function RepositorySetupForm({ provider, initial }, ref) {
