...
function Badge({
  ...
  const finalVariant = variant || bg || "default";

  // Apply CSS custom properties for retention badge colors
  const retentionBadgeStyle = finalVariant.startsWith("retention-badge-")
    ? { backgroundColor: `var(--color-badge-${finalVariant.replace("retention-badge-", "")})` }
...
Badge.propTypes = {
  ...
  variant: PropTypes.oneOf([
    ...
    'danger', 'info', 'retention-badge-warning', 'retention-badge-danger',
    'retention-badge-info', 'retention-badge-primary', 'retention-badge-secondary',
    'retention-badge-success', 'snapshot-pin'
  ]),
  bg: PropTypes.string, // Legacy Bootstrap prop
  text: PropTypes.string // Legacy Bootstrap prop
};
