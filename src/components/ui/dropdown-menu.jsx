...
const Dropdown = ({ children }) => <DropdownMenu>{children}</DropdownMenu>;
const DropdownToggle = React.forwardRef(({ children, variant = "outline", size = "default", ...props }, ref) => (
...
const DropdownMenu2 = ({ children }) => <DropdownMenuContent>{children}</DropdownMenuContent>;
const DropdownItem = ({ onClick, children, ...props }) => (
  <DropdownMenuItem onClick={onClick} {...props}>
    {children}
  </DropdownMenuItem>
);
const DropdownDivider = () => <DropdownMenuSeparator />;
