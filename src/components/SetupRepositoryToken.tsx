...
interface SetupRepositoryTokenProps {
...
export const SetupRepositoryToken = forwardRef<SetupRepositoryTokenHandle, SetupRepositoryTokenProps>(
  function SetupRepositoryToken(props, ref) {
