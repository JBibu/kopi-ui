...
describe("useKopiaTable", () => {
  ...
  it("should initialize with default values", () => {
    const { result } = renderHook(() => useKopiaTable<TestData>({ data: mockData, columns }), { wrapper });
  ...
  it("should preserve selection when data changes", () => {
    ...
    const updatedData = [...mockData, { id: 6, name: "New User", email: "new@example.com", status: "active" }];
