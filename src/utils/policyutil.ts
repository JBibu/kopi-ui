...
export function checkPolicyPath(path: string): string | null {
  if (path === "(global)") {
...
export function PolicyTypeName(s: SourceInfo): string {
...
export function policyEditorURL(s: SourceInfo): string {
